...
/* harmony import */ var _utils_displayTagNameCorrectly__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/displayTagNameCorrectly */ "./src/utils/displayTagNameCorrectly.js");
...
const TagPage = ({
  ...
  const pageTitle = `${(0,_utils_displayTagNameCorrectly__WEBPACK_IMPORTED_MODULE_7__["default"])(tag)} States`;
  const shouldUseWide = ['desktop', 'tablet', 'macOS'];
  let columnCount = 3;
  let wide = false; // Reduce the column count when desktop or tablet tagged
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
    title: pageTitle
    ...
    title: pageTitle
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_gallery__WEBPACK_IMPORTED_MODULE_3__["default"], {
    columnCount: columnCount,
    wide: wide
  }, previews), numPages > 1 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_pagination__WEBPACK_IMPORTED_MODULE_6__["default"], {
    numPages: numPages,
...
const pageQuery = "186071247";
TagPage.propTypes = {
  data: prop_types__WEBPACK_IMPORTED_MODULE_8___default().shape({
    allMarkdownRemark: prop_types__WEBPACK_IMPORTED_MODULE_8___default().shape({
      edges: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().array.isRequired)
    })
  }),
  pageContext: prop_types__WEBPACK_IMPORTED_MODULE_8___default().shape({
    tag: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string.isRequired),
    numPages: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number.isRequired),
    currentPage: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number.isRequired)
  })
};

/***/ }),

/***/ "./src/utils/displayTagNameCorrectly.js":
/*!**********************************************!*\
  !*** ./src/utils/displayTagNameCorrectly.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const displayTagNameCorrectly = tag => {
  ...
  switch (lowerTag) {
    ...
    default:
      return lodash_capitalize__WEBPACK_IMPORTED_MODULE_0___default()(tag);
  }
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayTagNameCorrectly);
